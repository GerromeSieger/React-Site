    ...
    steps {
        ...
        insert(1) {
            dockerCommand {
                ...
                commandType = other {
                    subCommand = "run"
                    commandArgs = """-e DOCKER_USERNAME="%env.DOCKERHUB_USERNAME%" -e DOCKER_PASSWORD="%env.DOCKERHUB_PASSWORD%" docker:dind sh -c "echo ${'$'}{'${'$'}'}DOCKER_PASSWORD | docker login -u ${'$'}{'${'$'}'}DOCKER_USERNAME --password-stdin""""
                }
            }
        }
    }
